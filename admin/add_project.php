                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="block form-block mb-4">
                            ...
                            <form action="add_project_proc.php" class="horizontal-form" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">Enter Project Name</label>
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter product name" type="text" name="name">
                                        </div>
                                    </div>
                                </div>
                                    <div class="form-row">
										...
										<select name="designer"  class="form-control">
                                            ...
                                            <option>Complete Designer</option>
                                            <option>Commercial Designer</option>
                                            <option>Home interior</option>
                                            <option>Landscap interior</option>
										</select>	
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter project description" type="text" name="des">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter project challenge" type="text" name="challenge">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter project client" type="text" name="client">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter project location" type="text" name="location">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter project duration" type="text" name="duration">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter project architect name" type="text" name="architect_name">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter project date" type="date" name="date">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter price" type="number" name="price"> 
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter price" type="file" name="image"> 
                                        </div>
                                    </div>
                                </div>
