                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="block form-block mb-4">
                            ...
                            ?>
                            <form action="edit_project_proc.php" class="horizontal-form" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">Enter Project Name</label>
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter product name" type="text" name="name" value="<?php echo $row[1]; ?>">
                                        </div>
                                    </div>
                                </div>
                                    <div class="form-row">
                                        ...
                                        <select name="designer"  class="form-control">
                                            <option selected value="<?php echo $row[3]; ?>">Architect Designer</option>
                                            <option selected value="<?php echo $row[3]; ?>">Complete Designer</option>
                                            <option selected value="<?php echo $row[3]; ?>">Commercial Designer</option>
                                            <option selected value="<?php echo $row[3]; ?>">Home interior</option>
                                            <option selected value="<?php echo $row[3]; ?>">Landscap interior</option>
                                        </select>   
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">Enter Project Description</label>
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter project description" type="text" name="des" value="<?php echo $row[4]; ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">Enter Project Challenge</label>
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter project challenge" type="text" name="challenge"  value="<?php echo $row[5]; ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">Enter Project Client name</label>
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter project client" type="text" name="client"  value="<?php echo $row[6]; ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">Enter Project Location</label>
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter project location" type="text" name="location"  value="<?php echo $row[7]; ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">Enter Project Duration</label>
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter project duration" type="text" name="duration"  value="<?php echo $row[8]; ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">Enter Project Architect name</label>
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter project architect name" type="text" name="architect_name"  value="<?php echo $row[9]; ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">Enter Project Date</label>
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter project date" type="date" name="date"  value="<?php echo $row[10]; ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">Enter Project Price</label>
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter price" type="number" name="price"  value="<?php echo $row[11]; ?>"> 
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">Enter Project Image</label>
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter price" type="file" name="image"  value="<?php echo $row[2]; ?>"> 
                                        </div>
                                    </div>
                                </div>
