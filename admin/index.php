...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/pages_login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:50 GMT -->
<head>
    <meta charset="UTF-8">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="login-div">
						...
						<form id="needs-validation" action="admin_login.php"  method="post" novalidate>
                            <div class="form-group">
                                <label>Email Id</label>
                                <input class="form-control input-lg" placeholder="Enter email id " type="text" name="admin_id" required>
                                <div class="invalid-feedback">This field is required.</div>
                            </div>
                            <div class="form-group">
                                <label>Password</label>
                                <input class="form-control input-lg" placeholder="Enter password" type="password" name="admin_pwd" required>
                                <div class="invalid-feedback">This field is required.</div>
                            </div>
                         ...
                         <!--   <small class="text-muted mt-5 mb-1 d-block">Don't have an account? <a href="pages_register.html">Register Now!</a></small> -->
                     </form>
                    </div>
                </div>
            </div>
