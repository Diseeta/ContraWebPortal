                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><img alt="" src="../images/resource/<?php echo $row[2]; ?>" width="100px"></td>
										
										<td> <a href="edit_project.php?id=<?php echo $row[0]; ?>" >UPDATE </a>  <a href="project_delete.php?id=<?php echo $row[0]; ?>" > DELETE </a></td>
                                    </tr>
                                    <?php
