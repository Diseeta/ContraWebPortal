                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="block form-block mb-4">
                            ...
                            <form action="add_cat_proc.php" class="horizontal-form" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">Enter Category Name</label>
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Category Name" type="text" name="cname">
                                        </div>
                                    </div>
                                </div>
