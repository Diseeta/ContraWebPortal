                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="block form-block mb-4">
                            ...
                            <form action="edit_cat_proc.php" class="horizontal-form" method="post" enctype="multipart/form-data">
								<input type="hidden" value="<?php echo $id; ?>" name="id" />
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">Enter Category Name</label>
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Category Name" type="text" name="cname" value="<?php echo $row[1]; ?>">
                                        </div>
                                    </div>
                                </div>
