...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/tables_regular.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:50 GMT -->
<head>
    <meta charset="UTF-8">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><img alt="" src="../images/slider/<?php echo $row[1]; ?>" width="100px"></td>
										<td> <a href="edit_sub_slider.php?id=<?php echo $row[0]; ?>" >UPDATE </a> | <a href="slider_sub_delete.php?id=<?php echo $row[0]; ?>" > DELETE  </a></td>
                                    </tr>
                                    <?php
...
<!-- Mirrored from wow.designgurus.in/sideNavigationLayout/blue/tables_regular.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Nov 2017 08:07:53 GMT -->
</html>