                    ...
                    <div class="col-12 col-lg-8">
                        <div class="block form-block mb-4">
                            ...
                            <?php
                                ...
                                $id=$_GET["id"];
                                $result = mysql_query("select * from sub_slider where id=$id");
                                $row = mysql_fetch_row($result);
                            ?>


                            <form action="edit_slider_proc.php" class="horizontal-form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <img alt="" src="../images/slider/<?php echo $row[1]; ?>" width="100px">
                                        </div>
                                    </div>
                                </div>
