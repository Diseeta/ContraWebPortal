                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8">
                        <div class="block form-block mb-4">
                            ...
                            <form action="add_product_proc.php" class="horizontal-form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter product name" type="text" name="pname">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">Enter Quantity</label>
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter Quantity" type="number" name="qua"> 
                                        </div>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter Description" type="text" name="desc"> 
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Enter price" type="file" name="img1"> 
                                        </div>
                                    </div>
                                </div>
