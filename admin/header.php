    ...
    <div class="navigation-menu">
        ...
        <li>
                <a href="javascript:void(0);" class="have-submenu active">
                    ...
                    <span class="title">Main_Slider</span>
                </a>
                <!--Submenu-->
                <ul class="sub-menu">
                    <li>
                        <a href="add_main_slider.php">
                    ...
                    <li>
                        <a href="display_main_slider.php">
                            <span class="icon-thumbnail"><i class="dripicons-exit"></i></span>
            ...
            <li>
                <a href="javascript:void(0);" class="have-submenu active">
                    <span class="icon-thumbnail"><i class="dripicons-browser"></i></span>
                    <span class="title">Sub_Slider</span>
                </a>
                <!--Submenu-->
                <ul class="sub-menu">
                    <li>
                        <a href="add_sub_slider.php">
                            <span class="icon-thumbnail"><i class="dripicons-exit"></i></span>
                            <span class="title">ADD</span>
                        </a>
                    </li>
                    <li>
                        <a href="update_sub_slider.php">
                            <span class="icon-thumbnail"><i class="dripicons-exit"></i></span>
                            <span class="title">UPDATE/DELETE</span>
                        </a>
                    </li>
                    <li>
                        <a href="display_sub_slider.php">
                            <span class="icon-thumbnail"><i class="dripicons-exit"></i></span>
                            <span class="title">DISPLAY</span>
                        </a>
                    </li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a href="update_project.php">
                            <span class="icon-thumbnail"><i class="dripicons-exit"></i></span>
                            <span class="title">UPDATE/DELETE</span>
                        </a>
                    </li>
                    <li>
                        <a href="display_project.php">
                            <span class="icon-thumbnail"><i class="dripicons-exit"></i></span>
                            <span class="title">DISPLAY</span>
                        </a>
                    </li>
            ...
            <li>
                <a href="javascript:void(0);" class="have-submenu active">
                    <span class="icon-thumbnail"><i class="dripicons-browser"></i></span>
                    <span class="title">Shop_Category</span>
                </a>
                <!--Submenu-->
                <ul class="sub-menu">
                    <li>
            ...
            <li>
                <a href="javascript:void(0);" class="have-submenu active">
                    <span class="icon-thumbnail"><i class="dripicons-browser"></i></span>
                    <span class="title">New_employee</span>
                </a>
                <!--Submenu-->
                <ul class="sub-menu">
                    
                    <li>
                        <a href="New_employee_view.php">
                            <span class="icon-thumbnail"><i class="dripicons-exit"></i></span>
            ...
            <li>
                <a href="javascript:void(0);" class="have-submenu active">
                    <span class="icon-thumbnail"><i class="dripicons-browser"></i></span>
                    <span class="title">Product_Feedbacks</span>
                </a>
                <!--Submenu-->
                <ul class="sub-menu">
