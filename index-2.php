...
<head>
<meta charset="utf-8">
<title>Contra - Interior Creator HTML Template | Home Page 05</title>
<!-- Stylesheets -->
            ...
            <div class="main-box clearfix">
                ...
                <div class="outer-box clearfix">
                    <ul class="contact-info">
                        <li><span class="fa fa-phone"></span> (+84) 867-557-243</li>
                        <li><span class="fa fa-envelope-o"></span> <a href="#">Support@yourdomain.com</a></li>
                        <li><span class="fa fa-map-marker"></span> 4264  James Martin Circle</li>
                    </ul>
                </div>
                ...
                <ul class="navigation clearfix">
                    ...
                    <li class="dropdown"><a href="#">Services</a>
                        <ul>
                            ...
                            <li><a href="service-detail.php">Commercial Design</a></li>
                            <li><a href="service-detail.php">Landescape Design</a></li>
                            <li><a href="service-detail.php">Interior Design</a></li>
                            <li><a href="service-detail.php">Complete Interior</a></li>
                            <li><a href="service-detail.php">House Interior</a></li>
                    ...
                    <li class="dropdown"><a href="#">Shop</a>
                        <ul>
                            ...
                            <li><a href="login.php">Registration Page</a></li>
                        </ul>
                    </li>
            ...
            <div class="slide-item" style="background-image: url(images/main-slider/image-3.jpg);">
                <div class="auto-container">
                    <div class="content-box">
                        ...
                        <h2>Architecture <br> is a Visual Art.</h2>
        ...
        <div class="auto-container">
            ...
            <div class="services-carousel-two owl-carousel owl-theme">
                ...
                <div class="service-block-two">
                    <div class="inner-box">
                        <div class="image-box"><figure class="image"><a href="services.php"><img src="images/resource/service-4.jpg" alt=""></a></figure></div>
                        <div class="caption-box">
                            <h3><a href="services.php">ARCHITECTURE DESIGN</a></h3>
                            <div class="link-box"><a href="service-detail.php">Read More <i class="fa fa-angle-double-right"></i></a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-block-two">
                    <div class="inner-box">
                        <div class="image-box"><figure class="image"><a href="services.php"><img src="images/resource/service-5.jpg" alt=""></a></figure></div>
                        <div class="caption-box">
                            <h3><a href="services.php">INTERIOR DESIGN</a></h3>
                            <div class="link-box"><a href="service-detail.php">Read More <i class="fa fa-angle-double-right"></i></a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-block-two">
                    <div class="inner-box">
                        <div class="image-box"><figure class="image"><a href="services.php"><img src="images/resource/service-6.jpg" alt=""></a></figure></div>
                        <div class="caption-box">
                            <h3><a href="services.php">COMMERCIAL DESIGN</a></h3>
                            <div class="link-box"><a href="service-detail.php">Read More <i class="fa fa-angle-double-right"></i></a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-block-two">
                    <div class="inner-box">
                        <div class="image-box"><figure class="image"><a href="services.php"><img src="images/resource/service-7.jpg" alt=""></a></figure></div>
                        <div class="caption-box">
                            <h3><a href="services.php">LANDSCAPE DESIGN</a></h3>
                            <div class="link-box"><a href="service-detail.php">Read More <i class="fa fa-angle-double-right"></i></a></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="feature-block col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box">
                                ...
                                <h3><a href="service-detail.php">Perfect Design</a></h3>
                                ...
                                <div class="link-box"><a href="service-detail.php">Read More</a></div>
                            </div>
                        </div>
                        ...
                        <div class="feature-block col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box">
                                ...
                                <h3><a href="service-detail.php">Carefully Planned</a></h3>
                                <div class="text">A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</div>
                                <div class="link-box"><a href="service-detail.php">Read More</a></div>
                            </div>
                        </div>
                        ...
                        <div class="feature-block col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box">
                                ...
                                <h3><a href="service-detail.php">Smartly Execute</a></h3>
                                <div class="text">A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</div>
                                <div class="link-box"><a href="service-detail.php">Read More</a></div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="title-column col-lg-3 col-md-12 col-sm-12">
                    <div class="inner-column">
                        ...
                        <div class="btn-box"><a href="services.php" class="theme-btn btn-style-one">More Product</a></div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="news-block-two col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box">
                            ...
                            <div class="overlay-box"><a href="blog-detail.php"><i class="fa fa-link"></i></a></div>
                        </div>
                        <div class="caption-box">
                            <div class="inner">
                                <h3><a href="blog-detail.php">In Good Taste: Mark Finlay Architects & Interiors.</a></h3>
                                <ul class="info">
                                    <li>06 June 2018,</li>
                                    <li><a href="blog-detail-2.php">John Smith</a></li>
                                    <li><a href="blog-detail-2.php">3 Commets</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="news-block-two col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box">
                        ...
                        <div class="caption-box">
                            <div class="inner">
                                <h3><a href="blog-detail.php">The Lexury Apartment of sepcial interiors.</a></h3>
                                <ul class="info">
                                    <li>06 June 2018,</li>
                                    <li><a href="blog-detail-2.php">John Smith</a></li>
                                    <li><a href="blog-detail-2.php">3 Commets</a></li>
                ...
                <div class="news-block-two col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box">
                        ...
                        <div class="caption-box">
                            <div class="inner">
                                <h3><a href="blog-detail.php">6 Easy Ways to Create a Backyard Paradise.</a></h3>
                                <ul class="info">
                                    <li>06 June 2018,</li>
                                    <li><a href="blog-detail-2.php">John Smith</a></li>
                                    <li><a href="blog-detail-2.php">3 Commets</a></li>
                ...
                <div class="news-block-two col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box">
                        ...
                        <div class="caption-box">
                            <div class="inner">
                                <h3><a href="blog-detail.php">The Business metting room interior in the rank.</a></h3>
                                <ul class="info">
                                    <li>06 June 2018,</li>
                                    <li><a href="blog-detail-2.php">John Smith</a></li>
                                    <li><a href="blog-detail-2.php">3 Commets</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="footer-column col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="footer-widget recent-posts">
                                    ...
                                    <div class="widget-content">
                                        <div class="post">
                                            <div class="thumb"><a href="blog-detail.php"><img src="images/resource/post-thumb-1.jpg" alt=""></a></div>
                                            <h4><a href="blog-detail.php">Triangle Concrete House on lake</a></h4>
                                            <ul class="info">
                                                <li>26 Aug</li>
                                                <li>3 Comments</li>
                                            </ul>
                                        ...
                                        <div class="post">
                                            <div class="thumb"><a href="blog-detail.php"><img src="images/resource/post-thumb-2.jpg" alt=""></a></div>
                                            <h4><a href="blog-detail.php">The Amazing Interior for the Hotel art</a></h4>
                                            <ul class="info">
                                                <li>26 Aug</li>
                                                <li>3 Comments</li>
                                            </ul>
                                 ...
                                 <div class="footer-widget links-widget">
                                    ...
                                    <div class="widget-content">
                                        <ul class="list">
                                            ...
                                            <li><a href="blog-classic.php">News</a></li>
