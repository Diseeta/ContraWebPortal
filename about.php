            ...
            <div class="row">
                ...
                <div class="process-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <h4><a href="service-detail.php">Concept</a></h4>
                ...
                <div class="process-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <h4><a href="service-detail.php">Idea</a></h4>
                        <div class="text">When an unknown printer took a galley of type and scrambled it to make a book.</div>
                        <!-- <div class="link-box"><a href="service-detail.php">Read More</a></div> -->
                    </div>
                </div>
                ...
                <div class="process-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <h4><a href="service-detail.php">Design</a></h4>
                        <div class="text">When an unknown printer took a galley of type and scrambled it to make a book.</div>
                        <!-- <div class="link-box"><a href="service-detail.php">Read More</a></div> -->
                    </div>
                </div>
                ...
                <div class="process-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <h4><a href="service-detail.php">excecution</a></h4>
                        <div class="text">When an unknown printer took a galley of type and scrambled it to make a book.</div>
                        <!-- <div class="link-box"><a href="service-detail.php">Read More</a></div> -->
                    </div>
                </div>
    ...
    <section class="offer-section" style="background-image: url(images/background/6.jpg);">
        <div class="auto-container">
            <div class="row">
                <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <span class="title">Special Offer of 50%</span>
                        <h2><span>How to save </span> <br>of money on repairs</h2>
                        <span class="discount">Get Appointment</span>
                        <div class="text">Fill out the form and get your appointment </div>
                    </div>
                </div> 
